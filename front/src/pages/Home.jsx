    ...
    <div className="min-h-[calc(100vh-73px)] bg-slate-950 text-white flex flex-col items-center py-12 px-6">
      ...
      <div className="max-w-3xl text-center flex flex-col gap-4 mb-12">
        ...
        <p className="text-slate-400 text-lg md:text-xl font-medium">
          Upload an image of a vehicle. Our AI detects and reads Nepali/English license plates using YOLO and EasyOCR, then queues records for admin review.
        </p>
      </div>
      ...
      <div className="w-full flex flex-col gap-8">
        ...
        {isLoading && (
          <div className="w-full max-w-2xl mx-auto bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
            <Loader message="Uploading image to secure servers, detecting license plates with YOLO, and reading text with EasyOCR..." />
          </div>
        )}
